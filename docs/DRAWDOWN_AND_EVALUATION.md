...
- **AlphaPROBE** (Guo et al., 2026) — Alpha Mining via Principled Retrieval and On-graph Biased Evolution  
  Paper: https://arxiv.org/abs/2602.11917  
  Code: https://github.com/gta0804/AlphaPROBE  
  DAG-based factor mining with Bayesian retriever + multi-agent generator; Peking University + Zhengren Quant  
- **QuantaAlpha** (arXiv:2602.07085) — Evolutionary LLM-driven alpha mining, IC=0.1501 on CSI300  
...
- **Harvey, Liu, Zhu (2016)** — …and the Cross-Section of Expected Returns (Factor Zoo / 多重检验)  
